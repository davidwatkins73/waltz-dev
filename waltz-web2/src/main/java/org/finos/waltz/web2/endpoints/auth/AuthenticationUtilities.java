...
public class AuthenticationUtilities {
    ...
    public static void setUserAsAnonymous(Context request) {
        request.attribute(USER_KEY, UserUtilities.ANONYMOUS_USERNAME);
    }

    public static void setUser(Context request, String user) {
    ...
    public static boolean isAnonymous(Context request) {
