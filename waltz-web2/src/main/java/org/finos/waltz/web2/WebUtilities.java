...
import org.finos.waltz.web2.endpoints.auth.AuthenticationUtilities;
...
public class WebUtilities {
    ...
    public static long getLong(Context request,
                               String paramName) {
        checkNotNull(request, "request must not be null");
        checkNotNull(paramName, "paramName must not be null");

        return Long.parseLong(request.pathParam(paramName));
    }


    public static int getInt(Context request,
                             String paramName) {
        checkNotNull(request, "request must not be null");
        checkNotNull(paramName, "paramName must not be null");

        return Integer.parseInt(request.pathParam(paramName));
    }


    public static long getId(Context request) {
    ...
    public static String getUsername(Context request) {
     ...
     */
    public static EntityKind getKind(Context request) {
     ...
     */
    public static EntityKind getKind(Context request, String paramName) {
        checkNotNull(request, "request must not be null");
        return EntityKind.valueOf(request.pathParam(paramName));
    }
     ...
     */
    public static EntityReference getEntityReference(Context request) {
     ...
     */
    public static EntityReference getEntityReference(Context request, String kindParamName, String idParamName) {
        checkNotNull(request, "request must not be null");
        return mkRef(
     ...
     */
    public static <T> T readBody(Context request,
    ...
    public static <T> List<T> readList(Context request, Class<T> itemClass) throws IOException {
        return (List<T>) readBody(request, List.class);
    }



    public static List<Long> readIdsFromBody(Context req) throws IOException {
    ...
    public static List<String> readStringsFromBody(Context req) throws IOException {
        return readBody(req, List.class);
    }


    public static IdSelectionOptions readIdSelectionOptionsFromBody(Context request) throws java.io.IOException {
    ...
    public static <T extends Enum<T>> T readEnum(Context request,
                                                 String paramName,
                                                 Class<T> enumClass,
                                                 Function<String, T> failedParseSupplier) {
        String paramValue = request.pathParam(paramName);
    ...
    public static Optional<Integer> getLimit(Context request) {
        String limitVal = request.queryParam("limit");
        return Optional
                .ofNullable(limitVal)
                .map(Integer::valueOf);
    }
    ...
    public static Optional<java.util.Date> getDateParam(Context request) {
        String dateVal = request.queryParam("date");
        return Optional
                .ofNullable(dateVal)
                .map(s -> {
                    try {
    ...
    public static Optional<LocalDate> getLocalDateParam(Context request, String paramName) {
        String dateVal = request.pathParam(paramName);
